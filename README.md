...
- **Выборочное проксирование**: списки правил для проксирования и прямого подключения.
...
- **Удаленные списки**: загрузка списков по URL с автоматическим обновлением по расписанию (поддерживаются TXT и PAC-скрипты).
